 ...
 *
 * Response Body
 *   Disbled. To enable use LAYER0_CURL_SAVE_BODY=1 or LAYER0_CURL_SHOW_BODY=1
 *
 * or
 *
 * Response Body
...
async function printResponseBody(curlResponse, {
  ...
  if (!internalArgs.saveBody && !internalArgs.showBody) {
    logger.info(_chalk.default.yellow('  Disabled. To enable use LAYER0_CURL_SAVE_BODY=true or LAYER0_CURL_SHOW_BODY=true'));
  }

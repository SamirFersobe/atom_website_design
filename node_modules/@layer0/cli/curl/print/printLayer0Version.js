...
exports.default = printLayer0Version;
...
function printLayer0Version(curlResponse, {
  logger,
  internalArgs
}) {
  if (!internalArgs.x0v) {
  ...
  //  > "1866 4.13.9 14 2022-05-11T20" (buildNumber , packageVersion, environmentVersion, compiledAt) (see "0 curl docs.layer0.co") (LLNW)
  //
  // Other Options:

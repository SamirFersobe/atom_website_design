...
/**
 * Writes information about the deployment to .layer0/deployment-manifest.json. This allows
...
module.exports = function writeDeploymentManifest(appDir, build) {
  const dest = join(appDir, '.layer0', DEPLOYMENT_MANIFEST_FILE); // Note: I realize I could just write the build objeect verbatim and that I'm not even changing the names
  // of any fields here, but I think it's better to be strict about exactly what is written because it
  // becomes part of the public contract documented here: https://docs.layer0.co/guides/cli#section_deploy

...
module.exports = async function getSite(context, siteSlug, teamSlug = null) {
  var _teamSlug, _await$context$api$ge;

  // Get personal team slug if no teamSlug is provided
  teamSlug = (_teamSlug = teamSlug) !== null && _teamSlug !== void 0 ? _teamSlug : (_await$context$api$ge = await context.api.getPersonalTeam()) === null || _await$context$api$ge === void 0 ? void 0 : _await$context$api$ge.slug;

...
const getLayer0ConfigFilePath = require('../../utils/getLayer0ConfigFilePath');
...
exports.handler = async yargs => {
  ...
  try {
    ...
    if (!configPath) {
      throw new Error("No layer0.config.js found. Please ensure you are in your app's root directory.");
    }

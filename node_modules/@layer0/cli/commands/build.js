...
exports.describe = 'Builds your project for deployment on Layer0.';
exports.builder = {
  skipFramework: {
    type: 'boolean',
    alias: 's',
  ...
  includeSources: {
    type: 'boolean',
    describe: 'Includes source files in the bundle uploaded to Layer0 for debugging purposes based on the sources config in layer0.config.js.'
  },
